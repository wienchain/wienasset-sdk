...
BlockExplorer.prototype.getTransactionUtxos = function(address, assetId, callback) {
  this.rpc.post('gettransactionutxos', {address: address, assetId: assetId}, function(err, result) {
    if (err) return callback(err)
    var utxosTxidsAndIndexes = {}
    var utxos = []
